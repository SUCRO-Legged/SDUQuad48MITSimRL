...
std::string controlParameterValueToString(ControlParameterValue value,
  ...
  switch (kind) {
    ...
    case ControlParameterValueKind::VEC6_FLOAT:
          result += "[";
          result += numberToString(value.vec6f[0]) + ", ";
          result += numberToString(value.vec6f[1]) + ", ";
          result += numberToString(value.vec6f[2]) + ", ";
          result += numberToString(value.vec6f[3]) + ", ";
          result += numberToString(value.vec6f[4]) + ", ";
          result += numberToString(value.vec6f[5]) + "]";
          break;
    case ControlParameterValueKind::VEC6_DOUBLE:
          result += "[";
          result += numberToString(value.vec6d[0]) + ", ";
          result += numberToString(value.vec6d[1]) + ", ";
          result += numberToString(value.vec6d[2]) + ", ";
          result += numberToString(value.vec6d[3]) + ", ";
          result += numberToString(value.vec6d[4]) + ", ";
          result += numberToString(value.vec6d[5]) + "]";
          break;
    default:
  ...
  for (auto& key : keys) {
    ...
    switch (cp->_kind) {
      ...
      case ControlParameterValueKind::VEC6_DOUBLE: {
            ...
            assert(vv.size() == 6);
            Vec6<double> v;
            v<<(vv[0], vv[1], vv[2],vv[3],vv[4],vv[5]);
            cp->initializeVec6d(v);
        } break;
