...
void FSM_State_Passive<T>::onEnter()
{
    ...
    // qDes << 0, 0, 0;
    qdDes << 0, 0, 0;
    this->jointPDControl(0, sleep_jpos[0], qdDes, Kp, Kd);
    this->jointPDControl(1, sleep_jpos[1], qdDes, Kp, Kd);
    this->jointPDControl(2, sleep_jpos[2], qdDes, Kp, Kd);
    this->jointPDControl(3, sleep_jpos[3], qdDes, Kp, Kd);
}
